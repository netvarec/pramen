// The DEFAULT chrome: a sidebar rail beside a slim app bar.
//
...
export function SidebarChrome({
  ...
  useEffect(() => { setMenuOpen(false); }, [active, crumb]);
  ...
  const railNarrow = railIsNarrow(railChoice, useMediaQuery(MD_BREAKPOINT));
...
/** The global error banner, rendered by whichever chrome is mounted.
 *
 * A component rather than markup in `_layout.tsx`, because the two chromes put it in
 * different places: under the app bar in the rail's content column, under the rule in the
